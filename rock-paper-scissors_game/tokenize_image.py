# Extracted and modified from https://github.com/christiansafka/img2vec/blob/master/img2vec_pytorch/img_to_vec.py
import torch
...
class Tokenize_img():
    ...
    def get_vec(self, img, tensor=False):
        """ Get vector embedding from image
        :param img: tensor Image or list of tensor Images
